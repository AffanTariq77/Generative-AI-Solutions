...
const ContactForm = ({ onlyForm = false }: { onlyForm?: boolean }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitForm({
        platform: "Generative-AI-Solutions",
  ...
  <div className="space-y-1.5 xs:space-y-2">
    ...
    />
      ...
      <Button
        ...
        disabled={loading}
      >
        {loading ? "Scheduling..." : "Schedule a Strategy Session"}
      </Button>
    </form>
  );
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            We’ll show you exactly where LLMs can optimize your current workflow. No fluff, just engineering-backed efficiency.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Left Side - Benefits */}
          <div className="space-y-8">
            <h3 className="text-2xl sm:text-3xl font-bold">Ready to automate?</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    A custom GenAI implementation plan.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Learn which model fits your budget.
                  </p>
                </div>
              </div>
            </div>
