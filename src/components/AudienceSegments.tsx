  ...
  const segments = [
    {
      ...
      description:
        "Feature Velocity. Add \"Magic Write\" or \"AI Summary\" features to your SaaS product in weeks, not months.",
      cta: "Add GenAI Features",
    },
    {
      icon: Building2,
      title: "Enterprises",
      description:
        "Knowledge Management. Unlock the value of your accumulated data. Make every PDF, Slack thread, and email searchable and actionable.",
      cta: "Unify Your Knowledge",
    },
    {
      icon: Users,
      title: "Operations Teams",
      description: "Support Automation. Reduce ticket volume by deploying agents that can actually resolve user issues, not just apologize.",
